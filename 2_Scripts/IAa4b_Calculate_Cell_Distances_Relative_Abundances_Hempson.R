...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# METADATA
# This script calculates the community composition distance between raster cells of the Hempsom Herbivomes. 
#
...
# – Load Data ####
#––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
functional.community.matrix = read.csv("./3_Output/IAa3_Create_Functional_Community_Matrix/IAa3_functional_community_matrix_Hempson_relative_abundances.csv")
...
#range(functional.community.matrix[1:25], na.rm = T)
...
functional.community.matrix.relative.subsample = as.matrix(functional.community.matrix.relative.subsample)
...
system.time( # 4.396 s
  dist.matrix.abundance.rel.distance.SQchord <- distance(functional.community.matrix.relative.subsample[,columns.with.functional.groups],
                                                         method = "SQchord",
                                                         weights = NULL,
                                                         R = NULL,
                                                         dist = T,
...
# Save data
system.time( # 9.65s
  save(dist.matrix.abundance.rel.distance.SQchord, file = "./3_Output/IAa4_Calculate_Cell_Distances/IAa4_dist_matrix_abundance_rel_distance_SQchord_Hempson"))
...
range(dist.matrix.abundance.rel.distance.SQchord.matrix)
range(dist.matrix.abundance.rel.distance.SQchord.matrix, na.rm = T)
...
# Save data
system.time( # 18.983s
  save(dist.matrix.abundance.rel.distance.SQchord.matrix, file = "./3_Output/IAa4_Calculate_Cell_Distances/IAa4_dist_matrix_abundance_rel_distance_SQchord_matrix_Hempson"))


system.time( # 103.559s
  write.table(dist.matrix.abundance.rel.distance.SQchord.matrix, 
              "./3_Output/IAa4_Calculate_Cell_Distances/IAa4_dist_matrix_abundance_perc_SQchord_matrix_Hempson.csv",
              row.names = F,
              col.names = F,
              sep = ","))
...
system.time( # 11.883
  dist.matrix.abundance.rel.distance.SQchord.matrix.big <- as.big.matrix(dist.matrix.abundance.rel.distance.SQchord.matrix,
                                                                         type = "double",
                                                                         separated = F,
                                                                         backingfile = "IAa4_big_distance_matrix_Hempson.bin",
                                                                         descriptorfile = "IAa4_big_distance_matrix_Hempson.desc",
...
#–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––####
    ...
    #   They are included to have an object to test our code with, as calculations using the large distance matrix may take a long time.
...
# save(functional.community.matrix.relative.little.subsample.SQchord,file = "./3_Output/IAa4_Calculate_Cell_Distances/IAa4_dist_matrix_abundance_rel_distance_SQchord_matrix_Hempson_little")
# 
# 
...
# save(functional.community.matrix.relative.medium.subsample.SQchord,file = "./3_Output/IAa4_Calculate_Cell_Distances/IAa4_dist_matrix_abundance_rel_distance_SQchord_matrix_Hempson_medium")
# 
# 
...
# save(functional.community.matrix.relative.large.subsample.SQchord,file = "./3_Output/IAa4_Calculate_Cell_Distances/IAa4_dist_matrix_abundance_rel_distance_SQchord_matrix_Hempson_large")
